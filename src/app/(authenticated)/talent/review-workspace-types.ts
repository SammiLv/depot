...
export type ReviewWorkspaceData = {
  ...
  cycles: { departments: ReviewDepartment[]; cycles: ReviewCycle[]; participants: ReviewParticipant[]; templates: Pick<ReviewTemplate, "id" | "name" | "version">[]; candidates: ReviewCandidate[]; canCreateCycle: boolean; scopeName: string | null; scopeTotalCount: number | null };
